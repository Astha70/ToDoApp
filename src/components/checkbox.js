...
const Checkbox = ({checked = false,onClick}) => {
    // Renders a checkbox component that toggles based on the 'checked' prop
    return (
        <div onClick={onClick}>

            {/* Display unchecked icon if 'checked' prop is false */}
            {!checked && (
            ...
            {/* Display checked icon and apply 'checked' class if 'checked' prop is true */}
            {checked && (
